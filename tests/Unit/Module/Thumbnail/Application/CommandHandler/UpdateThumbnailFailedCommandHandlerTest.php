...
use TomaszBartusiakRekrutacjaSmartiveapp\Module\Thumbnail\Application\CommandHandler\UpdateThumbnailFailedCommandHandler;
...
class UpdateThumbnailFailedCommandHandlerTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->handler = new UpdateThumbnailFailedCommandHandler($this->thumbnailRepository, $this->eventBus);
    }

    public function testHandleUpdatesThumbnailAndDispatchesEvent(): void
    {
        $command = new UpdateThumbnailFailedCommand(1, 'Error message');
